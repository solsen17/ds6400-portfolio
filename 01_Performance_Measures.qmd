...
> Building reusable function for computing desired metrics:
> ** INSERT LATEX FORMULAS HERE **
...
#app_pred <- get_apparent(dev_sample, model_formula)
...
#fit <- glm(model_formula, data = dev_sample, family = binomial())
#test_pred <- eval_on_data(fit, test_sample)
```
...
# split_test <- split_sample_validate(dev_sample, model_formula, train_frac = .6667)

```

> Function for the regular bootstrap method
